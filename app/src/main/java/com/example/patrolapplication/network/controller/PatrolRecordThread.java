...
public class PatrolRecordThread extends Thread {

    private static final String TAG = "## PatrolRecordThread ## ";

    private UserDao userDao;
    private Map<String, Object> map;
    private String operation;

    public PatrolRecordThread(Map<String, Object> map, UserDao userDao, String operation) {
